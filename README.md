...
## Current Version: [3.0.13.1](https://github.com/SolidNerd/docker-teamspeak/blob/master/Dockerfile)
...
```
docker run -d --name="teamspeak_server" -p "9987:9987/udp" -p 10011:10011 -p 30033:30033 solidnerd/teamspeak:3.0.13.1
```
...
```
docker run -d --name="teamspeak_server"  --env-file=.envfile -p "9987:9987/udp" -p 10011:10011 -p 30033:30033  --link teamspeak-mysql:mysql solidnerd/teamspeak:3.0.13.1
```
...
3. Create Teamspeak Server Container :
   ...
   ```
   docker run -d --net teamspeak_nw --name="teamspeak_server" -p "9987:9987/udp" -p 10011:10011 -p 30033:30033 solidnerd/teamspeak:3.0.13.1
   ```
